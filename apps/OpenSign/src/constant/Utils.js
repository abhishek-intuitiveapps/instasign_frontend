...
// export const getWidgetType = (item, widgetName) => {
//   return (
//     <div className="flex flex-col items-center justify-center w-full py-3 cursor-pointer select-none">
//       <div className="w-12 h-12" style={{borderRadius: '0.75rem', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '0.25rem' }}>
//         <i className={`${item.icon}`} style={{ color: '#002864', fontSize: '1.5rem' }}></i>
//       </div>
//       <span className="text-xs font-medium text-center truncate w-full" style={{ color: '#002864' }}>
//         {widgetName}
//       </span>
//     </div>
//   );
