        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <div className="flex space-x-4">
              ...
              <a href="/" className="text-white/80 hover:text-white transition-colors cursor-pointer" target="_blank" rel="noopener noreferrer">
                <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18.77 7.46H14.5v-1.9c0-.9.6-1.1 1-1.1h3V.5h-4.33C10.24.5 9.5 3.44 9.5 5.32v2.15h-3v4h3v12h5v-12h3.85l.42-4z"/>
                </svg>
              </a>
              <a href="https://x.com/Instasign17966" className="text-white/80 hover:text-white transition-colors cursor-pointer" target="_blank" rel="noopener noreferrer">
                <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://www.instagram.com/instasign__/" className="text-white/80 hover:text-white transition-colors cursor-pointer" target="_blank" rel="noopener noreferrer">
                <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
